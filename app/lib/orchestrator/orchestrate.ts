...
/**
 * State machine: analyze artifacts and decide next action
 */
function analyzeArtifactsAndDecide(context: OrchestrationContext): OrchestrateResponse['decision'] {
...
export async function orchestrate(
  ...
  try {
    ...
    const decision = analyzeArtifactsAndDecide(context);
